...
简而言之，resultType控制查询SQL执行后返回值的类型或集合中的泛型，例如查询emp表中的单条记录，返回值是一个Emp对象，因此，resultType="com.daojia.mybatis.pojo.Emp"；
如果查询emp表中的多条记录，返回值是一个List，此时resultType的值应该集合中的泛型，因此resultType="com.daojia.mybatis.pojo.Emp"；
...
<mapper namespace="com.daojia.mybatis.dao.EmpMapper2">
    <select id="findById" resultType="com.daojia.mybatis.pojo.Emp">
